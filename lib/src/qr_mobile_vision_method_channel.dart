...
import 'package:gmschurch_qr_mobile_vision/src/qr_channel_reader.dart';
...
class MethodChannelQrMobileVision extends QrMobileVisionPlatform {
  ...
  Future<PreviewDetails> start({
    ...
    List<String> formatStrings = formatsOrDefault
    ...
    final details =
        (await methodChannel.invokeMapMethod<String, dynamic>('start', {
      'targetWidth': width,
      'targetHeight': height,
      'heartbeatTimeout': 0,
